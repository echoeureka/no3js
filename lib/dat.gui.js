  ...
  return /******/ (function (modules) {
    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var _NumberControllerBox2 = _interopRequireDefault(
          _NumberControllerBox
        );

        var _NumberControllerSlider = __webpack_require__(14);

        var _NumberControllerSlider2 = _interopRequireDefault(
          _NumberControllerSlider
        );
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Color.recalculateRGB = function (color, component, componentHexIndex) {
          if (color.__state.space === "HEX") {
            color.__state[component] = _math2.default.component_from_hex(
              color.__state.hex,
              componentHexIndex
            );
        ...
        Object.defineProperty(Color.prototype, "hex", {
          get: function get() {
            if (!this.__state.space !== "HEX") {
              this.__state.hex = _math2.default.rgb_to_hex(
                this.r,
                this.g,
                this.b
              );
          ...
          _common2.default.each(INTERPRETATIONS, function (family) {
            if (family.litmus(original)) {
              _common2.default.each(
                family.conversions,
                function (conversion, conversionName) {
          ...
          each: function each(obj, itr, scope) {
            ...
            if (ARR_EACH && obj.forEach && obj.forEach === ARR_EACH) {
              ...
              for (key = 0, l = obj.length; key < l; key++) {
                if (
                  key in obj &&
                  itr.call(scope, obj[key], key) === this.BREAK
                ) {
                  return;
                }
              }
              ...
              if (_this.initialValue === 0) {
                ...
                _this.__impliedStep =
                  Math.pow(
                    10,
                    Math.floor(
                      Math.log(Math.abs(_this.initialValue)) / Math.LN10
                    )
                  ) / 10;
              }
            } else {
              ...
              _common2.default.each(
                ...
                function (component) {
                  if (
                    ...
                    !_common2.default.isUndefined(
                      this.__color.__state[component]
                    ) &&
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var GUI = function GUI(pars) {
          ...
          params.resizable =
            _common2.default.isUndefined(params.parent) && params.resizable;

          if (
            params.autoPlace &&
            _common2.default.isUndefined(params.scrollable)
          ) {
          ...
          var useLocalStorage =
            ...
            localStorage.getItem(getLocalStorageHash(this, "isLocal")) ===
              "true";
              ...
              closed: {
                ...
                set: function set(v) {
                  ...
                  if (_this.__closeButton) {
                    _this.__closeButton.innerHTML = v
                      ? GUI.TEXT_OPEN
                      : GUI.TEXT_CLOSED;
                  }
                },
                ...
                set: function set(bool) {
                  if (SUPPORTS_LOCAL_STORAGE) {
                    ...
                    localStorage.setItem(
                      getLocalStorageHash(_this, "isLocal"),
                      bool
                    );
                  }
                },
          ...
          if (_common2.default.isUndefined(params.parent)) {
            ...
            if (SUPPORTS_LOCAL_STORAGE) {
              if (useLocalStorage) {
                ...
                var savedGui = localStorage.getItem(
                  getLocalStorageHash(this, "gui")
                );
            ...
            if (params.closeOnTop) {
              ...
              _dom2.default.addClass(
                this.__closeButton,
                GUI.CLASS_CLOSE_BOTTOM
              );
          ...
          if (params.autoPlace) {
            if (_common2.default.isUndefined(params.parent)) {
              if (autoPlaceVirgin) {
                ...
                _dom2.default.addClass(
                  autoPlaceContainer,
                  GUI.CLASS_AUTO_PLACE_CONTAINER
                );
          ...
          saveToLocalStorage = function saveToLocalStorage() {
            if (
              SUPPORTS_LOCAL_STORAGE &&
              localStorage.getItem(getLocalStorageHash(_this, "isLocal")) ===
                "true"
            ) {
              localStorage.setItem(
          ...
          /** @lends dat.gui.GUI */
          {
            ...
            remove: function remove(controller) {
              ...
              this.__controllers.splice(
                this.__controllers.indexOf(controller),
                1
              );
              var _this = this;
              _common2.default.defer(function () {
            ...
            onResize: function onResize() {
              ...
              if (root.__resize_handle) {
                _common2.default.defer(function () {
                  root.__resize_handle.style.height =
                    root.__ul.offsetHeight + "px";
                });
              }
            ...
            saveAs: function saveAs(presetName) {
              if (!this.load.remembered) {
                ...
                this.load.remembered = {};
                this.load.remembered[
                  DEFAULT_DEFAULT_PRESET_NAME
                ] = getCurrentPreset(this, true);
              }
              ...
              _common2.default.each(
                ...
                function (controller) {
                  ...
                  if (controller.__onFinishChange) {
                    controller.__onFinishChange.call(
                      controller,
                      controller.getValue()
                    );
                  }
        ...
        function augmentController(gui, li, controller) {
          ...
          _common2.default.extend(controller, {
            options: function options(_options) {
              ...
              if (
                _common2.default.isArray(_options) ||
                _common2.default.isObject(_options)
              ) {
          ...
          if (controller instanceof _NumberControllerSlider2.default) {
            var box = new _NumberControllerBox2.default(
              controller.object,
              controller.property,
              {
            ...
            var r = function r(returned) {
              ...
              if (
                _common2.default.isNumber(controller.__min) &&
                _common2.default.isNumber(controller.__max)
              ) {
        ...
        function recallSavedValue(gui, controller) {
          ...
          // remember?
          var matchedIndex = root.__rememberedObjects.indexOf(
            controller.object
          );
          ...
          if (matchedIndex !== -1) {
            ...
            if (controllerMap === undefined) {
              controllerMap = {};
              root.__rememberedObjectIndecesToControllers[
                matchedIndex
              ] = controllerMap;
            }
        ...
        function addSaveMenu(gui) {
          ...
          _dom2.default.bind(select, "change", function () {
            for (var index = 0; index < gui.__preset_select.length; index++) {
              gui.__preset_select[index].innerHTML =
                gui.__preset_select[index].value;
            }
          ...
          if (SUPPORTS_LOCAL_STORAGE) {
            ...
            var localStorageCheckBox = document.getElementById(
              "dg-local-storage"
            );
            ...
            if (
              localStorage.getItem(getLocalStorageHash(gui, "isLocal")) ===
              "true"
            ) {
          ...
          var newConstructorTextArea = document.getElementById(
            "dg-new-constructor"
          );
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var ControllerFactory = function ControllerFactory(object, property) {
          ...
          // Providing options?
          if (
            _common2.default.isArray(arguments[2]) ||
            _common2.default.isObject(arguments[2])
          ) {
            return new _OptionController2.default(
              object,
              property,
              arguments[2]
            );
          ...
          if (_common2.default.isNumber(initialValue)) {
            ...
            if (
              _common2.default.isNumber(arguments[2]) &&
              _common2.default.isNumber(arguments[3])
            ) {
              // has step?
              if (_common2.default.isNumber(arguments[4])) {
                return new _NumberControllerSlider2.default(
                  object,
                  property,
                  arguments[2],
                  arguments[3],
        ...
        var CenteredDiv = (function () {
          ...
          CenteredDiv.prototype.layout = function layout() {
            this.domElement.style.left =
              window.innerWidth / 2 -
              _dom2.default.getWidth(this.domElement) / 2 +
              "px";
            this.domElement.style.top =
              window.innerHeight / 2 -
              _dom2.default.getHeight(this.domElement) / 2 +
              "px";
          };
